...
bf16 audio transformer mode is also optional and not part of normal startup. It is heavier and 64 GB system RAM is recommended. See [docs/optional-bf16-audio.md](docs/optional-bf16-audio.md).
